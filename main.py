...
try: app_id = int(os.environ.get("app_id", "29228879"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "f8c420d7f974ef0a2bc23a9a4a0dc859")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "6885675123:AAH1uacnoj-7OTGBneu4ziYESm-_oWvFjdY")
except Exception as bot_token: print(f"⚠️ Bot Token Invalid {bot_token}")
try: custom_caption = os.environ.get("custom_caption", "<a href='t.me/adgmovies'>\n'{file_name}'\n\n┏━━━━•❅•°•❈•°•❅•━━━━┓\n💥★ ADG MOVIES™ ★💥\n┗━━━━•❅•°•❈•°•❅•━━━━┛</a>")
...
about_message = """
<b>• Name : AutoCaption</b>
<b>• Developer : <a href=https://t.me/scrooge010>[SC UPDATES]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/scrooge010>Click Here</a></b>
<b>• Source Code : Private</b>"""
